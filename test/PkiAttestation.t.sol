...
contract PkiAttestationTest is Test {
    ...
    bytes32 public constant TRUSTED_ROOT_FINGERPRINT =
    ...
    function _setupTestData() internal {
        ...
        string memory mockCert =
            "";
    ...
    function testValidAttestationSuccess() public {
        ...
        pkiAttestation.verifyAttestation(validHeaderB64, validPayloadB64, validX5cChain);
    }
    ...
    function testInvalidX5cLengthFails() public {
        ...
        pkiAttestation.verifyAttestation(validHeaderB64, validPayloadB64, invalidChain);
    }
    ...
    function testInvalidAlgorithmFails() public {
        ...
        vm.expectRevert("INVALID_CERT_CHAIN: Intermediate certificate signature invalid");
        pkiAttestation.verifyAttestation(invalidHeader, validPayloadB64, validX5cChain);
    }
    ...
    function testInvalidAudienceFails() public {
        ...
        vm.expectRevert("INVALID_CERT_CHAIN: Intermediate certificate signature invalid");
        pkiAttestation.verifyAttestation(validHeaderB64, invalidPayload, validX5cChain);
    }
    ...
    function testGasUsageWithinLimits() public {
        ...
        try pkiAttestation.verifyAttestation(validHeaderB64, validPayloadB64, validX5cChain) returns (bytes memory) {
    ...
    function testFullValidationFlow() public {
        ...
        vm.expectRevert("INVALID_CERT_CHAIN: Intermediate certificate signature invalid");
        pkiAttestation.verifyAttestation(header, payload, validX5cChain);
    }
